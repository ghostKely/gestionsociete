    ...
    public String effectuerTransfert(
        ...
        try {
            ...
            if (idDepotSource == null || idDepotDestination == null) {
                redirectAttributes.addFlashAttribute("error", "Veuillez sélectionner les dépôts source et destination");
                return "redirect:/transfert";
            }

            if (idDepotSource.equals(idDepotDestination)) {
                redirectAttributes.addFlashAttribute("error", "Le dépôt source et destination doivent être différents");
                return "redirect:/transfert";
            }
            ...
            if (stockDisponible < quantite) {
                redirectAttributes.addFlashAttribute("error",
                        "Stock insuffisant dans le dépôt source. Disponible: " + stockDisponible);
                return "redirect:/transfert";
            }
    ...
    public String annulerTransfert(
        ...
        try {
            ...
            if (transfertInfo.isEmpty()) {
                ...
                return "redirect:/transfert/historique";
            }
